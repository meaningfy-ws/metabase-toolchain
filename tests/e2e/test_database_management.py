...
MONGO_DB_AUTH_URL = os.environ.get('MONGO_DB_AUTH_URL', default=None)
MONGO_DB_NAME = os.environ.get('MONGO_DB_NAME', default="aggregates_db")


def test_create_mongodb_snapshot():
    mongodb_auth_url = MONGO_DB_AUTH_URL
    if mongodb_auth_url:
        mongodb_client = MongoClient(mongodb_auth_url)
        create_mongodb_snapshot(database_name=MONGO_DB_NAME,
