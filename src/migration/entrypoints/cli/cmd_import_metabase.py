...
from src.migration.services.import_metabase import import_metabase_data_from_file
...
class CmdRunner(BaseCmdRunner):
    ...
    def run_cmd(self):
        error = None
        try:
            import_metabase_data_from_file(self.host, self.user, self.password, self.file)
